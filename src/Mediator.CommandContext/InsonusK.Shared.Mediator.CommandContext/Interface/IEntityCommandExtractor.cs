...
public interface IEntityCommandExtractor<TEntity> where TEntity : EntityBase
{
    public Task<TEntity> GetAsync(IEntityKey cmd, CancellationToken cancellationToken = default);
}
